...
class B extends A {
    constructor() {
        super();   //super相当于A.prototype.constructor.call(this)
    }
}
//super()在B中 相当于A.prototype.constructor.call(this)
...
class B extends A {
    ...
    m() {
        super.print();  //普通方法中的super调用匪类方法时 方法内部的this指向当前的子类实例 实际上执行的时super.print.call(this)
    }
}
let b = new B();

//两条原型链的理解方式 作为一个对象 子类(B)的原型(__proto__属性)是父类(A); 作为一个构造函数，子类(B)的原型对象(prototype属性)是父类的原型对象(prototype属性)的实例
